...
const Negotiation = () => {
  ...
  const [tableContent, setTableContent] = useState([
    ...
    { vendor: "Dell Nigeria", price: "200,000", status: "Shortlisted" },
    { vendor: "Lenovo Nigeria", price: "150,000", status: "Withdrawn" },
    { vendor: "Asus Nigeria", price: "250,000", status: "Withdrawn" },
  ...
  return (
    <>
      <div className="flex flex-col py-4 px-4 md:px-6 gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[50%_40%] gap-24 items-start">
          ...
          <div className="flex flex-col bg-white px-4 py-6 rounded-md shadow-md">
            <div>
                        ...
                        >
                          ...
                          <TableCell>
                            <Link href={href} aria-disabled={isWithdrawn}>
                              <Button
                                className={`bg-[#0F1E7A] text-white capitalize cursor-pointer ${
                                  isWithdrawn
