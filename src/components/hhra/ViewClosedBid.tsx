...
const ViewClosedBid = () => {
  ...
  const [tableContent, setTableContent] = useState([
    { vendor: "HP Nigeria", price: "100,000", status: "Shortlisted" },
    { vendor: "Dell Nigeria", price: "200,000", status: "Closed" },
    { vendor: "Lenovo Nigeria", price: "150,000", status: "Withdrawn" },
    { vendor: "Asus Nigeria", price: "250,000", status: "Closed" },
    { vendor: "Apple Nigeria", price: "300,000", status: "Shortlisted" },
  ]);


  if (typeof window !== "undefined") {
    const params = new URLSearchParams(window.location.search);
    const shortlistedVendor = params.get("shortlistedVendor");
    if (shortlistedVendor) {
      setTableContent((prev) =>
        prev.map((item) =>
          item.vendor === shortlistedVendor
            ? { ...item, status: "Shortlisted" }
            : item
        )
      );
      params.delete("shortlistedVendor");
                    ...
                    {tableContent.map((item, index) => {
                      ...
                      const href =
                        item.status === "Withdrawn"
                          ? "#"
                          : item.status === "Shortlisted"
                          ? "/hhra/request?view=shortlisted"
                          : `/hhra/request?view=details&vendor=${encodeURIComponent(
                              item.vendor
                            )}`;
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            <Link href={href} aria-disabled={isWithdrawn}>
                              <Button
                                className={`bg-[#0F1E7A] text-white capitalize ${
                                  isWithdrawn
                ...
                <Dialog>
                  ...
                  <DialogContent className="flex flex-col bg-white w-[400px] h-[200px] justify-center items-center">
                    <DialogHeader className="flex items-center">
                      ...
                      <Link href={"/hhra/request?view=negotiation"}>
