...
const EditRequest = () => {
  ...
  return (
    <div className="flex flex-col py-4 px-4 md:px-6 gap-4">
      <p className="text-2xl text-[#0F1E7A] font-medium">Update Request</p>
            ...
            <Dialog>
              ...
              <DialogContent className="w-[400px] h-[350px] bg-white">
                ...
                <div className="flex flex-col gap-4">
                    <Button className="text-base text-[#0F1E7A] border-1 border-[#0F1E7A] font-medium hover:bg-[#0F1E7A26]">No</Button>
                    <Button variant="outline"className="border-1 border-[#DE1216] text-base text-[#DE1216]" >Yes</Button>
                </div>
              </DialogContent>
            </Dialog>
          </div>
